...
namespace DL
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> AnyosGet()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("AnyosGet");
        }
        ...
        public virtual ObjectResult<DESCONTINUADO_Result> DESCONTINUADO()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<DESCONTINUADO_Result>("DESCONTINUADO");
        }
        ...
        public virtual ObjectResult<OrderDate_Result> OrderDate()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<OrderDate_Result>("OrderDate");
        }
    
        public virtual ObjectResult<OrderDate2_Result> OrderDate2(Nullable<int> year)
        {
            var yearParameter = year.HasValue ?
                new ObjectParameter("Year", year) :
                new ObjectParameter("Year", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<OrderDate2_Result>("OrderDate2", yearParameter);
        }
    
        public virtual ObjectResult<PROMEDIO_Result> PROMEDIO()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PROMEDIO_Result>("PROMEDIO");
        }
